...
const rawValues = readLines().map((line) => parseInt(line, 10) * decryptKey);

const count = rawValues.length;
const entries = rawValues.map((value) => ({ value }));
